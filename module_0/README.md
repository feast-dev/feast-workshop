...
| :----------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <div style="width:120px">Data source</div> | Sources of data (in files or in data warehouses). Here we need a `FileSource` (with an S3 path and endpoint override) and `FeatureView`s registered with `feast apply`                                                                                                                                                                                               |
